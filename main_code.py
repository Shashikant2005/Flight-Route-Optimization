...
class mainGUI:
    ...
    def __init__(self,root):
        ...
        self.label_1=Label(root,text="Home Airport",bg='#90EE90',fg='black',font='Helvetica 10 bold')
        self.label_2=Label(root,text="Airport 1",bg='#90EE90',fg='black',font='Helvetica 10 bold')
        self.label_3=Label(root,text="Airport 2",bg='#90EE90',fg='black',font='Helvetica 10 bold')
        self.label_4=Label(root,text="Airport 3",bg='#90EE90',fg='black',font='Helvetica 10 bold')
        self.label_5=Label(root,text="Airport 4",bg='#90EE90',fg='black',font='Helvetica 10 bold')
        self.label_6=Label(root,text="--FUEL OPT--",bg='#90EE90',fg='black',font='Helvetica 40 bold')
        self.label_7=Label(root,text="Aircraft",bg='#90EE90',fg='black',font='Helvetica 10 bold')
        ...
        picture=PhotoImage(file='images/pic.png')
        label_pic=Label(image=picture,bg='#90EE90')
